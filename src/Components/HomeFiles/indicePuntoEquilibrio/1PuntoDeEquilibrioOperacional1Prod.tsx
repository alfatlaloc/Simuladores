    ...
    <section className="textosEncuadre">
      ...
      <div>
        ...
        <div className="teoriaSection">
          ...
          <br />
          <i className="mt-5">
            Tabla 2. Datos del producto 1 (hamburguesa sencilla){" "}
          </i>
          <br />
          ...
          <i>
            Figura 2. Fórmulas del punto de equilibrio para un producto sin
            utilidad{" "}
          </i>
          <br />
          ...
          <br />
          <p>
            Ahora realicemos la gráfica del punto de equilibrio, para lo cual
            necesitamos construir una tabla que nos oriente (ver tabla 3).
          </p>
          <i className="mt-5">
            Tabla 3. Información para graficar el punto de equilibrio{" "}
          </i>
          <br />
          ...
          <section className="leftAlign mt-5">
            Para realizar la gráfica del punto de equilibrio necesitamos los
            siguientes datos:
            <ol type="1">
              <li>Cantidad (Q)</li>
              <li>Costo fijo (CF)</li>
        ...
        <section id="subindice2">
          ...
          <div className="teoriaSection">
            <p>
              ...
              utilizando la fórmula que se muestra en la figura 4.
            </p>
            <i className="mt-5">
              Figura 4. Fórmulas del punto de equilibrio para un producto sin
              utilidad.{" "}
            </i>
            <br />
            ...
            <p>
              ...
              deseada, tal y como se puede observar en la tabla 4.
            </p>
